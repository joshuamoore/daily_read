  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved passage as @passage" do
        ...
        post :create, {:passage => { "name" => "invalid value" }}, valid_session
        expect(assigns(:passage)).to be_a_new(Passage)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested passage" do
        ...
        expect_any_instance_of(Passage).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => passage.to_param, :passage => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the passage as @passage" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Passage.any_instance.stub(:save).and_return(false)
        put :update, {:id => passage.to_param, :passage => { "name" => "invalid value" }}, valid_session
        expect(assigns(:passage)).to eq(passage)
      end
